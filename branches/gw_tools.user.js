...
//(object) unitName = [object Object]
//    (string) u9 = Supply Helicopter
//    (string) u8 = Tank
//    (string) u5 = Infantry
//    (string) u4 = Anti-Tank Infantry
//    (string) u7 = Mobile SAM
//    (string) u6 = Sniper
//    (string) u1 = Supply Truck
//    (string) u2 = X
//    (string) u19 = Cargo Transport
//    (string) u18 = Special Forces
//    (string) u11 = Gunship
//    (string) u10 = Fighter
//    (string) u13 = Stealth Bomber
//    (string) u12 = Bomber
//    (string) u15 = unitName#u15
//    (string) u14 = unitName#u14
//    (string) u17 = Predator Drone
//    (string) u16 = Hellfire Tank
//(object) ResourceName = [object Object]
//    (string) 0 = Gold
//    (string) 1 = Food
//    (string) 2 = Oil
//    (string) 3 = Stone
...
//    (string) 10 = Time
 ...
 var t = Tabs.Info;
    ...
    var m = '<STYLE>.xtabH {background:#ffffe8; border:none; padding-right: 5px; padding-left: 5px; margin-left:10px; }\
        ...
        <TR align=center><TD class=xtab></td><TD class=xtabHL colspan=5><B>COST TO BUILD</b></td><TD class=xtabHL colspan=5><B>STATS</b></td><TD class=xtabHL><B>Upkeep</b></td></tr>\
        <TR valign=bottom align=right><TD class=xtab></td><TD class=xtabHL>Food</td><TD class=xtabH>Oil</td><TD class=xtabH>Steel</td>\
        <TD class=xtabH>Titan</td><TD class=xtabH>Pop</td><TD class=xtabHL>Might</td><TD class=xtabH>Life</td><TD class=xtabH>Atk</td><TD class=xtabH>Speed</td><TD class=xtabH>Load</td>\
...
//    <TD class=xtab align=left><B>'+ cost[0].substr(0,16) +'</b></td><TD class=xtabL>'+ cost[1] +'</td><TD class=xtab>'+ cost[2] +'</td>\
      m += '<TD class=xtab align=left><B>Unit Names Here</b></td><TD class=xtabL>'+ cost[2] +'</td><TD class=xtab>Oil</td>\
            <TD class=xtab>Steel</td><TD class=xtab>Titan</td><TD class=xtab>Pop</td><TD class=xtabL></td>';
//       m += '<TD class=xtab>'+ stats[0] +'</td><TD class=xtab>'+ stats[1] +'</td><TD class=xtab>'+ stats[3] +'</td><TD class=xtab>'+ stats[5] +'</td>\';
//          <TD class=xtab>'+ stats[4] +'</td><TD class=xtab>'+ stats[5] +'</td><TD class=xtabL>'+ food +'</td>
      m += '</tr>';
//
    }
...
Tabs.Options = {
  ...
  init : function (div){
    ...
    try {      
      ...
      m += '</table><BR><BR><HR>Note that if a checkbox is greyed out there has probably been a change of GW\'s code, rendering the option inoperable.';
      t.cont.innerHTML = m;
...
//
//***** New one but didnt seam to work corectly
//		function clickedShowScripts (){
//			var resultsDiv = document.getElementById('idDebugResultsDiv')
//			var scripts = document.getElementsByTagName('script');
//			var s = '';
